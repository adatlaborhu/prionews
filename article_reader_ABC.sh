...
#echo test2
#cut the article
curl $(echo $(cat $actual_article_name |cut -f1)?singlePage=true) | html2text -ascii -nometa\
|tr '[:upper:]' '[:lower:]' |tr '*' '+' |sed '1,/++++++/d'\
|sed -n -e '/join the discussion/q;p' |sed -n -e '/&#8212;&#8212;&#8212/q;p' \
|tail -n+3 |grep -v "associated press" > /home/mtomi/IGAZHIR/ACTUAL/$1_TMP/1.tsv
#echo test3
#1
